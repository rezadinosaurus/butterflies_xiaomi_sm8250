...
#define MHI_TIMESYNC_DB_SETUP(er_index) \
	((((MHI_TIMESYNC_CHAN_DB << TIMESYNC_CFG_CHAN_DB_ID_SHIFT) & \
	   TIMESYNC_CFG_CHAN_DB_ID_MASK) | \
	  ((1 << TIMESYNC_CFG_ENABLED_SHIFT) & TIMESYNC_CFG_ENABLED_MASK) | \
	  (((er_index) << TIMESYNC_CFG_ER_ID_SHIFT) & \
	   TIMESYNC_CFG_ER_ID_MASK)))

#define MHI_BW_SCALE_SETUP(er_index) \
	((((MHI_BW_SCALE_CHAN_DB << BW_SCALE_CFG_CHAN_DB_ID_SHIFT) & \
	   BW_SCALE_CFG_CHAN_DB_ID_MASK) | \
	  ((1 << BW_SCALE_CFG_ENABLED_SHIFT) & BW_SCALE_CFG_ENABLED_MASK) | \
	  (((er_index) << BW_SCALE_CFG_ER_ID_SHIFT) & \
	   BW_SCALE_CFG_ER_ID_MASK)))
